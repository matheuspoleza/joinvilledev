      ...
      <div className="relative z-10 flex flex-col min-h-screen px-4 py-8 md:py-12">
        ...
        <header className="w-full max-w-6xl mx-auto mb-8 md:mb-12">
          <div className="flex items-center justify-between mb-8">
            <div className="text-xs md:text-sm px-3 py-1.5 rounded-full bg-zinc-800 border border-zinc-700 text-zinc-300">
              1ª Edição • 2026
            </div>
        ...
        <div className="flex-1 w-full max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-6">
              ...
              <span className="text-primary">em Joinville</span>!
            </h2>
          </div>
          ...
          <div className="text-center space-y-6">
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 text-sm md:text-base text-zinc-400">
              ...
              <Tooltip.Root>
                <Tooltip.Trigger asChild>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 rounded-full bg-primary px-8 py-4 text-base md:text-lg font-medium text-primary-foreground shadow-soft shadow-primary/30 transition-transform duration-150 hover:-translate-y-1 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                  >
        ...
        {/* Footer */}
        <footer className="mt-12 md:mt-16 w-full max-w-6xl mx-auto pt-6 border-t border-border/60 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-zinc-500">
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            ...
            <span className="underline underline-offset-4 decoration-zinc-700">
...
function FloatingIcons() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      {/* React Icon */}
      <div
        className="absolute top-20 left-10 w-16 h-16 md:w-24 md:h-24 opacity-20 animate-float"
      ...
      {/* JavaScript Icon */}
      <div
        className="absolute top-40 right-20 w-14 h-14 md:w-20 md:h-20 opacity-20 animate-float"
      ...
      {/* Python Icon */}
      <div
        className="absolute bottom-32 left-16 w-16 h-16 md:w-24 md:h-24 opacity-20 animate-float"
      ...
      {/* React Icon (segunda posição) */}
      <div
        className="absolute top-1/2 right-12 w-12 h-12 md:w-18 md:h-18 opacity-15 animate-float"
      ...
      {/* JavaScript Icon (segunda posição) */}
      <div
        className="absolute bottom-20 right-1/4 w-10 h-10 md:w-16 md:h-16 opacity-15 animate-float"
      ...
      {/* Python Icon (segunda posição) */}
      <div
        className="absolute top-1/3 left-1/4 w-12 h-12 md:w-18 md:h-18 opacity-15 animate-float"
...
function EventCardLarge({ title, description, status }: EventCardLargeProps) {
  return (
    <div className="rounded-3xl border border-border bg-muted/60 p-6 md:p-8 flex flex-col gap-4 hover:bg-muted/80 transition-colors">
      <div className="flex items-start justify-between gap-4">
        <h3 className="text-xl md:text-2xl font-bold text-foreground">{title}</h3>
        <span className="inline-flex items-center rounded-full border border-zinc-700 bg-zinc-900/60 px-3 py-1 text-xs uppercase tracking-[0.15em] text-zinc-400 whitespace-nowrap">
          {status}
        </span>
      </div>
